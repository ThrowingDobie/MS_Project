// MS_Project.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_MS_PROJECT, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MS_PROJECT));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_MS_PROJECT);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_ACTIVATE:
		...
		{
			g_pD3DDevice->mAppPaused = true;
			g_pTimer->Stop();
		}
		else
		{
			g_pD3DDevice->mAppPaused = false;
			g_pTimer->Start();
		}
		return 0;
